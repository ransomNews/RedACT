...
**ransomNews** è un progetto indipendente di ricerca e divulgazione dedicato al monitoraggio e all’analisi delle rivendicazioni ransomware a livello globale.

Nato come attività di ricerca autonoma nel tempo libero, ransomNews è oggi il risultato di oltre **tre anni di raccolta dati, analisi e tracciamento sistematico** delle attività di gruppi ransomware, leak site e campagne di estorsione digitale.

L’obiettivo del progetto è **fare awareness**, fornendo informazioni verificabili e tecnicamente accurate sulla minaccia ransomware, senza sensazionalismi e senza opinioni personali.
...
Il progetto è attivo su diverse piattaforme:

- Website  
  https://ransomnews.online

- LinkedIn  
  https://www.linkedin.com/company/ransomnews

- X (Twitter)  
  https://x.com/ransomnews

- Bluesky  
  https://bsky.app/profile/ransomnews.online
...
- threat intelligence
- studio dell’evoluzione dei gruppi criminali
...
Una rivendicazione pubblicata da un gruppo ransomware **non costituisce prova definitiva di compromissione**, ma rappresenta una dichiarazione pubblica dell’attaccante.
...
Salvo diversa indicazione, i contenuti di ransomNews sono distribuiti per finalità informative e di ricerca.

Si prega di citare la fonte quando si utilizzano dati o analisi del progetto.

---

## 🔐 Perché esiste ransomNews
...
**La consapevolezza è il primo livello di difesa.**
